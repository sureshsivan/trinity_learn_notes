...
* every module have access to some local variaoble this, module, exports, __dirname, __filename

* __proto__  -  property which refers to prototype of every object in v8
